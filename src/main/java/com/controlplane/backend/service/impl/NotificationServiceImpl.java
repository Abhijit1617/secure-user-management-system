...
public class NotificationServiceImpl implements NotificationService {
    ...
    public NotificationPreferenceResponse updatePreferences(UUID userId, UpdateNotificationPreferenceRequest request) {
        ...
        return notificationMapper.toPreferenceResponse(notificationPreferenceRepository.save(preference));
    }

    @Override
    @Transactional
    public void createFromEvent(UUID recipientUserId, NotificationType type, String title, String message,
        ...
        NotificationPreference preference = notificationPreferenceRepository.findByUser(recipient)
        ...
        if (preference.isEmailEnabled()) {
            emailService.sendNotificationEmail(recipient.getEmail(), recipient.getFirstName(), title, message);
        }
    }

    private NotificationPreference defaultPreference(User user) {
        return notificationPreferenceRepository.save(NotificationPreference.builder().user(user).build());
    }
